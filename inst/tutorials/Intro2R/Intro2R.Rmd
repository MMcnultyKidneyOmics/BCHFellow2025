...
quiz(
  question("Which statement(s) are true:",
           ...
           answer("The mean age for those on the treatment is 51.9", correct = TRUE),
           answer("The mean age for those without treatment is 29.01", correct = TRUE),
...
Email `michelle.mcnulty@childrens.harvard.edu` if you would like the original csv so you can practice in your own RSudio. 
